---
title: "ME315_list3"
author: "Eduardo Gomes de Carvalho (RA:183541)"
format: html
editor: visual
---
...
con <- dbConnect(SQLite(), "C:/Users/Eduardo Gomes/Downloads/me315.sqlite")
```
...
Os 2 primeiros comandos retornam o mesmo reesultado, porem no primeiro utilizamos menos comandos, por issoseria mais vantajoso utiliza-lo em vez do segundo, e o mesmo se aplica ao terceiro comando, o qual poderiamos chegar ao mesmo resultado com menos comandos, o que exigiria menos processamento da maquina.
...
Sim as seguintes clausulas são equivalentes!
...
Nao, cada uma das clausulas possui uma lógica diferente - a primeira seleciona todas as reservas com os states diferente de MA que possuem acres maior que 50 - a segunda seleciona as reservas cujo acres é maior que 50 e que são de MA - a terceira seleciona tdas as reservas com acress maior ou igual a 50 e com state diferente de MA
...
Nao, apenas a primeira e a ulltima clausula sao equivalentes mas a segunda é diferente 
